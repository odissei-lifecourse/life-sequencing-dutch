...
def encode_documents(docs_with_counter, primary_key, write_path_prefix, needed_ids, do_mlm, mlm):
  ...
  for document in docs:
    ...
    if (
      ...
      continue
    person_id = person_dict[primary_key]
